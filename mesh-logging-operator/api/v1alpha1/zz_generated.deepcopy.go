...
func (in *ParserSpec) DeepCopyInto(out *ParserSpec) {
	*out = *in
	out.SingleLineParser = in.SingleLineParser
	out.MultilineParser = in.MultilineParser
}
...
// DeepCopyInto is an autogenerated deepcopy function, copying the receiver, writing into out. in must be non-nil.
func (in *SingleLineParser) DeepCopyInto(out *SingleLineParser) {
	*out = *in
}

// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new SingleLineParser.
func (in *SingleLineParser) DeepCopy() *SingleLineParser {
	if in == nil {
		return nil
	}
	out := new(SingleLineParser)
	in.DeepCopyInto(out)
	return out
}
