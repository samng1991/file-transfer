...
func MakeAlertPatternConfigMaps(loggingNamespace string, alertPatternList []AlertPattern, AlertPatterns []loggingv1alpha1.AlertPatternItem) appsv1.ConfigMap {
	ds := appsv1.ConfigMap{
